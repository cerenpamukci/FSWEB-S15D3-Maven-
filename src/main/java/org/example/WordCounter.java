...
public class WordCounter {
    ...
    public static void main(String[] args) {
        ...
        String text = "When the offensive resumed, the Turks received their first victory when the Greeks encountered stiff resistance in the battles of First and Second İnönü," +
                ...
                " Almost of year of stalemate without much fighting followed, during which Greek morale and discipline faltered while Turkish strength increased." +
    ...
    // Static method to calculate the word frequency
